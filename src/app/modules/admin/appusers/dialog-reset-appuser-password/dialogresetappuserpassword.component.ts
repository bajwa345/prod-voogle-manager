...
@Component({
    selector    : 'dialog-reset-appuser-password',
    templateUrl : './dialogresetappuserpassword.component.html',
    styleUrls   : []
})
export class DialogResetAppUserPasswordComponent implements OnInit, OnDestroy {
    ...
    constructor(@Inject(MAT_DIALOG_DATA) public data: {rowData: any, eDom: HTMLElement},
        private dialogRef: MatDialogRef<DialogResetAppUserPasswordComponent>,
    ...
    onSubmit(){
        ...
        try {
            this.appUsersService.resetAppUserPassword(requestObject)
