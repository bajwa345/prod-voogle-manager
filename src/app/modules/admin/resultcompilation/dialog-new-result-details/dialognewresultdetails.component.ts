...
@Component({
    selector    : 'dialog-new-result-details',
    templateUrl : './dialognewresultdetails.component.html',
    styleUrls   : []
})
export class DialogNewResultDetailsComponent implements OnInit, OnDestroy {
    ...
    constructor(@Inject(MAT_DIALOG_DATA) public data: {rowData: any, eDom: HTMLElement},
        private dialogRef: MatDialogRef<DialogNewResultDetailsComponent>,
