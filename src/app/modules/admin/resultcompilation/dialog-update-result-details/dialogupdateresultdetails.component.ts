...
@Component({
    selector    : 'dialog-update-result-details',
    templateUrl : './dialogupdateresultdetails.component.html',
    styleUrls   : []
})
export class DialogUpdateResultDetailsComponent implements OnInit, OnDestroy {
    ...
    constructor(@Inject(MAT_DIALOG_DATA) public data: {rowData: any, eDom: HTMLElement},
        private dialogRef: MatDialogRef<DialogUpdateResultDetailsComponent>,
